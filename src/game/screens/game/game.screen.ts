...
import ObstacleContainer from "./obstacles/container";
...
export default class GameScreen extends BaseScreen {
  ...
  constructor(app: Application) {
    ...
    let container = new ObstacleContainer();
    this.addChild(container);
    container.x = 1280;
    container.y = 720;
    this.collisionManager.addObstacleCollider(container);
    this.collisionManager.onCollisionEventEmmiter.addListener(
      CollisionManager.E_COLLISION,
      (obstacle: ObstacleContainer) => {
